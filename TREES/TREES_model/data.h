...
class Data_point
{
		...
		Data_point operator =(const Data_point& rhs);
                ...
                //output method
                friend ostream& operator << (ostream& out, const Data_point& dp);
...
class Regr_Res
{
		...
		//output method
                friend ostream& operator << (ostream& out, const Regr_Res& res);
...
class Data_Frame
{
		...
		//output method
		friend ostream& operator << (ostream& out, const Data_Frame& df);
